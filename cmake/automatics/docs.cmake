...
configure_file("${GXZN_GXZN_CHRONO_DOCS_DIR}/Doxyfile.in" "${doxyfile}" @ONLY NEWLINE_STYLE LF)

add_custom_target(clear_docs
	COMMENT "Cleaning documentation"
	COMMAND "${CMAKE_COMMAND}" -E remove_directory
		"${GXZN_GXZN_CHRONO_DOCS_DIR}/html"
		"${GXZN_GXZN_CHRONO_DOCS_DIR}/xml"
)
...
if (CMAKE_VERSION VERSION_LESS 3.27)
	add_custom_target(generate_docs
		...
		WORKING_DIRECTORY ${GXZN_GXZN_CHRONO_DOCS_DIR}
